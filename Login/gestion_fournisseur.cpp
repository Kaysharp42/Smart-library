...
void gestion_fournisseur::on_pushButton_3_clicked()
{
...
void gestion_fournisseur::on_pushButton_4_clicked()
{
...
void gestion_fournisseur::on_pushButton_5_clicked()
{
    ui->tableaff->setModel(tmpfournisseur.AfficherT());

}
void gestion_fournisseur::on_ajouter_2_clicked()
{
...
void gestion_fournisseur::on_pushButton_8_clicked()
{
...
void gestion_fournisseur::on_pushButton_9_clicked()
{
    QString Type =ui->comboBox->currentText() ;
     QMessageBox msBox;
...
void gestion_fournisseur::on_affichsup_clicked()
{
    ui->tableView_2->setModel(tmpfournisseur.afficher_fournisseur());
     ui->nomasup->setModel(tmpfournisseur.afficher_nomfournisseur());
}

void gestion_fournisseur::on_afficher2_clicked()
{
  ui->tableaff->setModel(tmpfournisseur.afficher_fournisseur());
}

void gestion_fournisseur::on_modifierc_clicked()
{
...
void gestion_fournisseur::on_refreshc_clicked()
{
    ui->tableView_5->setModel(tmpcommandef.afficher_commandef());
     ui->num->setModel(tmpcommandef.afficher_numc());
}

void gestion_fournisseur::on_affcmd_clicked()
{
